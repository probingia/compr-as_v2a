...
export const initializeDOM = () => {
    ...
    dom.exportImportModal = document.getElementById('exportImportModal');
    ...
    dom.exportSelectionModal = document.getElementById('exportSelectionModal');
    ...
    dom.importResultModal = document.getElementById('importResultModal');
    dom.importResultBody = document.getElementById('import-result-body');

    dom.importHelpModal = document.getElementById('importHelpModal');

    // Confirmación
    dom.confirmModalEl = document.getElementById('confirmModal');
